...
// Pure colour-science functions live in shaders/dcp.wgsl (concatenated at
// load time). Only the orchestration lives here.
...
fn dcp_apply(cam_rgb: vec3<f32>) -> vec3<f32> {
    ...
    // BaselineExposureOffset: multiplicative gain between HueSatMap and LookTable.
    rgb = dcp_baseline_exposure(rgb, ad.dcp_baseline_exposure_offset);
